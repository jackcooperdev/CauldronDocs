...
|--------------------------------------------------------|---------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
| [CauldronCLI](/cli/introduction)                   | [Latest Releases](https://github.com/jackcooperdev/CauldronCLI/releases) | Client that manages profiles and provides a CLI and websocket interface for other applications to use |
